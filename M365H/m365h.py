...
\    \_\  \  | \/  __ \|  |_> |   \  \/        \  |_> \___  |
 \______  /__|  |____  |   __/|___|  /_______  /|__|   \/
    ...
    parser.add_argument("-i","--interface", type=str, default="0.0.0.0", help="The interface to bind to. Use 0.0.0.0 for all interfaces. (Default = 0.0.0.0)")
    parser.add_argument("-p", "--port", type=int, default=5000, help="The port to bind to. (Default = 5000)")
